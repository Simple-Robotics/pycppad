...
#ifndef __pycppad_register_hpp__
#define __pycppad_register_hpp__
...
namespace pycppad
{
  ...
  /// \brief Structure collecting all the types registers in Numpy via Pycppad
  struct Register
  {
...
#endif // __pycppad_register_hpp__
